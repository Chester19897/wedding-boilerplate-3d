...
const NavMenu = () => {
  return (
    <>
      ...
      <div className="md:hidden navbar bg-base-100 z-[100] px-5 py-5 sticky top-0 backdrop-blur-lg bg-white/70 shadow flex">
        <div className="inline-flex items-center flex-1">
          <h1>
            <a
              className="flex items-center justify-center gap-1 text-5xl text-[#837a7a]"
              href="/"
            >
              Việt{' '}
              <svg
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <li className="flex py-1">
                <a
                  href="#section0"
                  className="text-[16px] font-[500] text-[#3f3f46]"
                >
                  Home
                </a>
              </li>
