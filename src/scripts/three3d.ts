...
import '../styles/webGi/styles.scss'
...
async function setupViewer() {
  ...
  const camView4 = document.querySelector('.cam-view-4') as HTMLElement
  const camView5 = document.querySelector('.cam-view-5') as HTMLElement
  ...
  const materialsMenu = document.querySelector(
    '.materials--menu'
  ) as HTMLElement
  const configMaterial = document.querySelector(
    '.config--material'
  ) as HTMLElement
  const configGem = document.querySelector('.config--gem') as HTMLElement
  const closeConfigMaterial = document.querySelector(
    '.close-materials'
  ) as HTMLElement
  ...
  importer.addEventListener('onStart', (_ev) => {
    // onUpdate()
  })
  ...
  importer.addEventListener('onLoad', (_ev) => {
    if (firstLooad) {
      introAnimation()
    } else {
      gsap.to('.loader', {
  ...
  let ring: Mesh<BufferGeometry, MeshStandardMaterial2>,
    gold: Mesh<BufferGeometry, MeshStandardMaterial2>,
    silver: Mesh<BufferGeometry, MeshStandardMaterial2>
  let diamondObjects: any[] = []

  if (ringModel == 1) {
    ring = viewer.scene.findObjectsByName('Scene')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
    silver = viewer.scene.findObjectsByName('silver')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
    gold = viewer.scene.findObjectsByName('gold')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
    ...
    ring = viewer.scene.findObjectsByName('ring-compare')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
    silver = viewer.scene.findObjectsByName('alliance')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
    gold = viewer.scene.findObjectsByName('entourage')[0] as any as Mesh<
      BufferGeometry,
      MeshStandardMaterial2
    >
  ...
  function introAnimation() {
    ...
    introTL
      ...
      .fromTo(
        ...
        {
          x: isMobile ? 1.28 : 1.28,
          y: isMobile ? -1.7 : -1.7,
          z: isMobile ? 5.86 : 5.86,
          duration: 4,
          onUpdate
        },
        '-=0.8'
      ...
      .fromTo(
        ...
        },
        {
          ...
          y: isMobile ? 0.03 : 0.03,
          z: isMobile ? -0.25 : -0.25,
          duration: 4,
          onUpdate
        },
        '-=4'
  ...
  function setupScrollAnimation() {
    ...
    tl.to(position, {
      ...
      .to(ring.rotation, {
        x: ringModel == 1 ? 0 : -Math.PI / 3,
        y: ringModel == 1 ? 0 : -0.92,
        z: ringModel == 1 ? Math.PI / 2 : 0,
        scrollTrigger: {
          trigger: '.cam-view-2',
          start: 'top bottom',
          end: 'top top',
          ...
          onUpdate: function () {
            if (!usingCustomColors) {
              silver.material.color.lerpColors(
                new Color(0xfefefe).convertSRGBToLinear(),
                new Color(0xd28b8b).convertSRGBToLinear(),
                colorLerpValue.x
              )
              gold.material.color.lerpColors(
                new Color(0xe2bf7f).convertSRGBToLinear(),
                new Color(0xd28b8b).convertSRGBToLinear(),
                colorLerpValue.x
              )
              for (const o of diamondObjects) {
                o.material.color.lerpColors(
                  ...
                  new Color(0x39cffe).convertSRGBToLinear(),
                  colorLerpValue.x
                )
              }
            }
      ...
      .to(ring.rotation, {
        x: ringModel == 1 ? 0 : 0.92,
        y: ringModel == 1 ? 0 : 0.92,
        z: ringModel == 1 ? -Math.PI / 2 : Math.PI / 3,
        scrollTrigger: {
          trigger: '.cam-view-3',
          start: 'top bottom',
          end: 'top top',
        ...
        { x: 0 },
        {
          ...
          onUpdate: function () {
            if (!usingCustomColors) {
              silver.material.color.lerpColors(
                new Color(0xd28b8b).convertSRGBToLinear(),
                new Color(0xf7c478).convertSRGBToLinear(),
                colorLerpValue2.x
              )
              gold.material.color.lerpColors(
                new Color(0xd28b8b).convertSRGBToLinear(),
              ...
              for (const o of diamondObjects) {
                o.material.color.lerpColors(
                  new Color(0x39cffe).convertSRGBToLinear(),
                  new Color(0xf70db1).convertSRGBToLinear(),
                  colorLerpValue2.x
                )
              }
            }
    ...
    tlExplore
      ...
      .to(
        '.emotions--content',
        {
          ...
          duration: 1.5,
          ease: 'power4.out',
          onComplete: onCompleteConfigAnimation
        },
        '-=2.5'
      )
      .fromTo(
  ...
  async function loadNewModel() {
    if (ringModel == 1) {
      ...
      ring = viewer.scene.findObjectsByName('Scene_1')[0] as any as Mesh<
        BufferGeometry,
        MeshStandardMaterial2
      >
      silver = viewer.scene.findObjectsByName('alliance')[0] as any as Mesh<
